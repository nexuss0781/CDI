...
|---|---|---|
| CCT-G3.3 — Controlled Harmonic-Memory-Band Contribution Ablation | A pre-registered exact harmonic-disabled control, local causal/state/gradient/parameter gates, exact configuration, `REPORT.md`, and `latest.json` under the frozen CCT-G3 contract | CCT-G2.1 quality rerun, CCT-G2.2, context work, capacity changes, corpus expansion, or optimization work |
